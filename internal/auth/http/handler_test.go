...
func TestRequiredCapabilityDoesNotTreatGraphCommandsAsReadQueries(t *testing.T) {
	tests := []struct {
		...
		{path: "/api/v1/proposals/10000000-0000-4000-8000-000000000001/revision-merge-previews", method: http.MethodPost, want: []capability.Capability{capability.ReadLocal}},
		{path: "/api/v1/proposals/10000000-0000-4000-8000-000000000001/revisions", method: http.MethodGet, want: []capability.Capability{capability.ReadLocal}},
		{path: "/api/v1/proposals/10000000-0000-4000-8000-000000000001/revisions/10000000-0000-4000-8000-000000000002", method: http.MethodGet, want: []capability.Capability{capability.ReadLocal}},
		{path: "/api/v1/proposals/10000000-0000-4000-8000-000000000001/revisions", method: http.MethodPost, want: []capability.Capability{capability.WriteProposal}},
