...
var capabilityRoutes = []capabilityRoute{
	...
	oneCapability(http.MethodPost, "/api/v2/review/interviews/{session_id}/complete", capability.WriteProposal),
	oneCapability(http.MethodPut, "/api/v2/review/learning-paths/{path_id}/steps/{step_id}", capability.WriteProposal),
	...
	oneCapability(http.MethodPost, "/api/v1/workspaces/{workspace_id}/attachment-exports", capability.ReadLocal),
	...
	oneCapability(http.MethodGet, "/api/v1/workspaces/{workspace_id}/synthesis/notes/{note_id}/interviews/{preparation_id}", capability.ReadLocal),
	oneCapability(http.MethodPost, "/api/v1/workspaces/{workspace_id}/synthesis/notes/{note_id}/interviews/{preparation_id}/retry", capability.WriteProposal),
