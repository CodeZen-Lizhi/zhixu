...
> **已被 ADR-0022 在完整 RAG、Tool/ReAct 与 Token Streaming 的生产结论取代。** Checkpoint/Interrupt
> PoC-only 与 PostgreSQL/River 唯一跨进程恢复事实源的结论继续有效。

ADR-0019 已采用 Eino Chat、Callback telemetry 和 Structured Output 短 Graph，ADR-0020 已采用可回滚的
