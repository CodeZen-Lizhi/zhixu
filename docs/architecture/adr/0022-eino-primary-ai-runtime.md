...
ADR-0019、ADR-0020 已分别验证 Eino Chat、Callback、Structured Scheduler 和双 Provider Embedding。
ADR-0021 在当时没有产品消费者时，对完整 RAG、Tool/ReAct 和 Token Streaming 作出生产 No-Go。用户现已明确
批准把这些能力接入现有 `/chat` RAG，因此本决策取代 ADR-0021 中这三项 No-Go；Checkpoint/Interrupt 的生产
...
- [ADR-0019](0019-layered-eino-adoption.md)：Chat、Callback 与短 Graph 分层采用。
- [ADR-0020](0020-eino-embedding-adoption.md)：OpenAI-Compatible/Ollama Embedding 采用。
- [ADR-0021](0021-eino-runtime-expansion-gates.md)：被本决策部分取代的历史门禁；Checkpoint 结论继续有效。
