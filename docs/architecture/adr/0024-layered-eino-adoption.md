...
> 本 ADR 只记录当时获准的基线范围。后续 Embedding 采用见 ADR-0025；完整 RAG、Tool/ReAct、
> Token Streaming 与 Checkpoint/ADK 的实际门禁结论见 ADR-0026。
>
> **已被 ADR-0027 在 Eino 正式生产默认、RAG、Tool/ReAct 与 Streaming 的对应范围取代。** 本 ADR 的
...
- Embedding/Retriever/Rerank、完整 RAG Graph、Token Streaming、Checkpoint/Interrupt、只读 Tool Calling 和旧实现删除仍需独立门禁；本 ADR 不提前授权这些能力。Embedding 后续由 ADR-0025 授权，其余路线由 ADR-0026 记录实际 No-Go/PoC-only 结论。
...
- [ADR-0026](0026-eino-runtime-expansion-gates.md)：完整 RAG、Tool、Streaming、Checkpoint/ADK 门禁结论。
