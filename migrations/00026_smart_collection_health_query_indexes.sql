...
DROP INDEX IF EXISTS idx_ops_health_issue_workspace_target_status_type;
DROP INDEX IF EXISTS idx_knowledge_relation_workspace_source_status_type;
DROP INDEX IF EXISTS idx_knowledge_relation_workspace_target_status_type;
