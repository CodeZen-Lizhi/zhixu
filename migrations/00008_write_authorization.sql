...
DROP TRIGGER IF EXISTS tool_authorization_verify_binding ON change_control.tool_authorization;
DROP TRIGGER IF EXISTS tool_authorization_reject_delete ON change_control.tool_authorization;
DROP FUNCTION IF EXISTS change_control.validate_tool_authorization_transition();
DROP FUNCTION IF EXISTS change_control.verify_tool_authorization_binding();
DROP FUNCTION IF EXISTS change_control.reject_tool_authorization_delete();
DROP TABLE IF EXISTS change_control.tool_authorization;
DELETE FROM core.schema_meta WHERE key = 'write_authorization';
