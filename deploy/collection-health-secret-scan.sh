...
if [[ "${mode}" == "--source" ]]; then
  ...
  paths=(
    ...
    "${REPOSITORY_ROOT}/migrations/00025_smart_collection_health.sql"
    "${REPOSITORY_ROOT}/migrations/00026_smart_collection_health_query_indexes.sql"
    "${REPOSITORY_ROOT}/migrations/00027_health_schedule_delivery.sql"
    "${REPOSITORY_ROOT}/migrations/00028_health_affected_change_outbox.sql"
