-- Freeze source-identity prompt pairs without rewriting any historical input or proof.
...
RETURNS boolean LANGUAGE sql STABLE AS $$
 ...
 (semantic='v7' AND generation=CASE version WHEN 'v1' THEN 'v7' WHEN 'v2' THEN 'v8' WHEN 'v3' THEN 'v9' WHEN 'v4' THEN 'v10' WHEN 'v5' THEN '' END)
 ), expected AS (
