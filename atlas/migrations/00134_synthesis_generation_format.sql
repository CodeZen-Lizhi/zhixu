-- Freeze the explicit generation-format prompt pairs without rewriting earlier contracts.
...
RETURNS boolean LANGUAGE sql STABLE AS $$
 ...
 (semantic='v8' AND fusion_bound AND generation=CASE version WHEN 'v2' THEN 'v17' WHEN 'v4' THEN 'v18' END)
 ), expected AS (
