...
本目录是独立 Go module，用于保留 ADR-0013 的历史采用门禁和后续能力验证。ADR-0024 后主模块锁入 Eino Chat
Adapter 与短 Graph，ADR-0025 增加双 Provider Embedding Adapter；Domain、Workflow、Proposal/Approval 仍不依赖
Eino。ADR-0026 记录完整 RAG、Tool、Streaming、Checkpoint/ADK 的实际 Go/No-Go 结论。
...
历史与复验结论见 [report.md](report.md)，当前 Eino-only 生产采用范围以 ADR-0027 为准；ADR-0026 的
