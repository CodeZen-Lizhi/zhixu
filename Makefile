...
compose-check: compose-auth-check compose-runtime-check compose-static-models-check compose-runtime-contract compose-workspace-check compose-workspace-contract compose-smoke-cleanup-contract smoke-image-cleanup-contract compose-rag-real-provider-contract launcher-contract model-secrets-init-contract
