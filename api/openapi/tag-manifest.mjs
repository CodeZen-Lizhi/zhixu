...
const EXACT_TAGS = new Map([
  ["listSynthesisProcessingSourceReviews", "Synthesis"],
  ["listSynthesisRevisionSourceReviews", "Synthesis"],
  ["getSynthesisSourceReview", "Synthesis"],
  ["recheckSynthesisSourceReview", "Synthesis"],
  ["recoverSynthesisSourceReview", "Synthesis"],
  ["openSynthesisSourceReviewEvidence", "Synthesis"],

  ["getSynthesisHistoricalRepublish", "Synthesis"],
  ["beginSynthesisHistoricalRepublish", "Synthesis"],
  ["applySynthesisHistoricalRepublish", "Synthesis"],
  ["getSynthesisHistoricalRepublishTarget", "Synthesis"],
  ["resumeSynthesisHistoricalRepublish", "Synthesis"],
  ["getSynthesisCandidateRemergeTarget", "Synthesis"],
  ["beginSynthesisCandidateRemerge", "Synthesis"],
  ["getSynthesisCandidateRemerge", "Synthesis"],
  ["applySynthesisCandidateRemerge", "Synthesis"],
  ["resumeSynthesisCandidateRemerge", "Synthesis"],

 ["listWorkspaceDiscoveryFailures", "Workspaces"],
  ["listRecentAnchorFusionRequests", "Synthesis"],
  ["getSynthesisSourceGraph", "Synthesis"],
  ["getSynthesisSourceImpacts", "Synthesis"],
  ["getSynthesisBodyImpacts", "Synthesis"],
  ["getSynthesisUpdateSummaries", "Synthesis"],
  ...
  ["listSynthesisSupplements", "Synthesis"],
  ["openSynthesisSupplement", "Synthesis"],
  ["listAnchorRecommendations", "Synthesis"],
  ["requestAnchorRecommendation", "Synthesis"],
  ["getAnchorRecommendation", "Synthesis"],
  ["retryAnchorRecommendation", "Synthesis"],
  ["listKnowledgeAnchors", "Synthesis"],
  ["createKnowledgeAnchor", "Synthesis"],
  ["getKnowledgeAnchor", "Synthesis"],
  ["listAnchorScopeProposals", "Synthesis"],
  ["listAnchorAssociations", "Synthesis"],
  ["decideAnchorScopeProposals", "Synthesis"],
  ["decideAnchorAssociations", "Synthesis"],
  ["listSynthesisGoalSelections", "Synthesis"],
  ["retrySynthesisGoalSelection", "Synthesis"],
  ["listSynthesisGoals", "Synthesis"],
  ["createSynthesisGoal", "Synthesis"],
  ["promoteSynthesisSource", "Synthesis"],
  ["getSynthesisGoal", "Synthesis"],
  ...
  ["getSynthesisSourceKnowledgePoints", "Synthesis"],
  ["getSourceKnowledgeDirectory", "Synthesis"],
  ["listSynthesisProcessing", "Synthesis"],
  ["getSynthesisProcessing", "Synthesis"],
  ["getSynthesisManuscriptReview", "Synthesis"],
  ["getSynthesisManuscriptNoteReview", "Synthesis"],
  ["decideSynthesisManuscript", "Synthesis"],
  ["resumeSynthesisManuscript", "Synthesis"],
