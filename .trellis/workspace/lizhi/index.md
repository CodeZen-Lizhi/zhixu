...
|---|------|-------|---------|--------|
| 95 | 2026-09-16 | 分功能提交主笔记需求并推送中文注释版本 | `b0dab884`, `f888ad60`, `4adf6343`, `0cf2ad3d`, `f3980246` | `dev` |
| 94 | 2026-09-16 | 原笔记目录受控重绑与DeepSeek正式启用 | - | `dev` |
| 93 | 2026-09-16 | DeepSeek 五类真实融合通过与版本化兼容修复 | - | `dev` |
| 92 | 2026-09-16 | DeepSeek 复核格式版本化与真实质量缺口 | - | `dev` |
| 91 | 2026-09-16 | DeepSeek 配置保存、探测修复与目录身份恢复边界 | - | `dev` |
| 90 | 2026-09-16 | 确认先用 Chat 并重测用户调整后的网关 | - | `dev` |
| 89 | 2026-09-16 | 部署最新本地服务并启用 BGE，调研 Agent 协议兼容性 | - | `dev` |
| 88 | 2026-09-16 | 模型配置增量独立复核与剩余验收校准 | - | `dev` |
| 87 | 2026-09-16 | 按功能思考强度与BGE向量模型接入 | - | `dev` |
| 86 | 2026-09-16 | 模型思考强度设置与请求参数接通 | - | `dev` |
| 85 | 2026-09-15 | 历史主笔记恢复与同正文发布收口 | - | `dev` |
| 84 | 2026-09-15 | 当前全文补源与恢复链路收口 | - | `dev` |
...
| 11 | 2026-07-17 | M5 Git writeback adapter | `9894844` | `dev` |
| 10 | 2026-07-17 | M5-04B Filesystem CAS | `b0a6484` | `dev` |
| 9 | 2026-07-17 | M5-04A Safe Writeback Persistence | `39565ea`, `f53e95b` | `dev` |
| 8 | 2026-07-17 | M5 Write Authorization | `87ea888` | `dev` |
| 7 | 2026-07-17 | 完成 M5 摄取解析与规范化分块 | `2a8e681`, `584ec5d` | `dev` |
...
| 2 | 2026-07-16 | M2 Eino 隔离采用门禁 | `91b42ce` | `dev` |
| 1 | 2026-07-16 | M1 可运行骨架交付 | `2e5610a` | `dev` |
<!-- @@@/auto:session-history -->
