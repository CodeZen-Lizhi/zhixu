...
| [状态管理](./state-management.md) | Server、URL、Local Draft 和 Event 所有权 | 已记录 M7-03 Workspace cache、Collection/Health cursor，以及 M9 唯一 SSE Owner、cursor 提交/恢复和 Workspace 切换契约 |
| [类型安全](./type-safety.md) | API/SSE 校验和 Domain UI Type | 已记录 M7-03 Collection/Health strict decoder，以及 M9 Business strict decoder、Workspace/ID 绑定、Proposal 联合与审批阶段语义 |
| [质量规范](./quality-guidelines.md) | 测试、禁止模式和 Review Gate | 已记录 M7-01 Graph、M7-02 Candidate 与 M7-03 Collection/Health 的 decoder、URL/query、交互、恢复和真实浏览器门禁 |
