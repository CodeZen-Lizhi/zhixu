...
ADR-0022 将 Eino 设为正式生产 AI Runtime：Chat、OpenAI-Compatible/Ollama Embedding 和五个 Structured
...
- Eino 历史 PoC 保存在 [`poc/eino`](../../../poc/eino)。当前正式路径以 ADR-0022 为准：Chat、Embedding、
