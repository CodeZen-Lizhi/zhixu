...
| T04 | Implement bounded neighborhood queries | Graph PG adapter/application | T02,T03 | depth1 result-window cursor and depth2/3 cycle/budget tests on real PG; complete layers and no N+1 | recursive explosion | in_progress |
