...
| T09 | Wire production API and readiness | `internal/app/router.go`, `cmd/api/main.go`, config tests | T08 | real dependencies only; missing config fail closed; existing routes unaffected | partial assembly | in_progress |
