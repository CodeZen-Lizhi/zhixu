...
| T05 | Implement deterministic shortest path | Graph application/PG frontier seam | T02,T03 | batch bidirectional BFS proves all best-hop meetings, full path-key tie-break, directed/symmetric/filter/common-topic/no-path/cancel/budget; no per-node SQL | false shortest path | in_progress |
