...
| T07 | Prove query plans and add only required indexes | migration + integration/EXPLAIN tests | T03-T06 | representative plans avoid full scan on adjacency; repeat migration; rollback strategy | index guess/write cost | in_progress |
