...
| T08 | Implement Graph HTTP/OpenAPI over application cursor | `internal/graph/http`, `api/openapi` | T03-T07 | strict JSON, node search, opaque cursor mapping, 404/405/503/timeout, discriminated schema, OpenAPI gate | wire drift | in_progress |
