...
| T11 | Implement minimum real `/graph` page | routes, Graph components/styles | T10 | three modes, search/legend, URL recovery, session lock/fixed layout, bounded SVG/list, lazy drawer, all explicit states, keyboard/a11y | graph hairball | in_progress |
