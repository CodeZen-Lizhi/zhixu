...
| T13 | Sync authoritative docs and run full quality gate | `README.md`, product PRD, API/events, database, frontend, performance/testing docs, relevant specs/task | T01-T12 | commands below pass; each authority matches Topic/Claim scope, path/cursor/failure contract and M10 boundary | false completion | in_progress |
