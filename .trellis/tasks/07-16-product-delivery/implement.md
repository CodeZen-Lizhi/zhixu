...
| M6-04 | M6 | 实现 RAG API、会话、SSE 流式展示和反馈评测 | `internal/app/**`, `web/src/features/rag/**` | M1-04,M6-02,M6-03 | RAG E2E、SSE reconnect、拒答样本 | 流式草稿被误当完成 | 主 Agent + 子 Agent | 进行中：T01-T03 契约、迁移与领域模型已完成；T04 Repository 开始实施，HTTP/SSE/前端/E2E 尚未完成 |
