...
| M6-01 | M6 | 实现 FTS/pgvector/Embedding/Index Version/RRF/Dedup/Rerank Adapter | `internal/retrieval/**`, `queries/**` | M5-02,M3-01,M2-02 | 检索 contract、过滤正确、降级显式、index switch | 向量维度/中文分词 | 子 Agent | 进行中：M6-A Retrieval Index Foundation 已完成并通过真实 PostgreSQL/race/EXPLAIN 门禁；M6-B/C/D 待实施 |
