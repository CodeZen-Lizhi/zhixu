...
> ADR 编号冲突已解决：`0019-layered-eino-adoption.md` 是 Chat/Callback/短 Graph 基线，
> `0020-eino-embedding-adoption.md` 是 Embedding 扩展采用，`0021-eino-runtime-expansion-gates.md`
...
- [x] ADR-0020 接受 Embedding 扩展采用，ADR-0021 接受其余路线的实际 Go/No-Go 结论。
