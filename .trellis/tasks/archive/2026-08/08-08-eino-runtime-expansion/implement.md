...
2. 新增 ADR-0027，取代 ADR-0026 的生产 No-Go，冻结 Eino-primary、事实源边界和草稿语义；2026-08-11 再明确删除旧 direct Runtime 与运行时回滚面，Git 历史负责恢复。
...
- [x] 用户已于 2026-08-14 授权合并到 `dev`，由本次集成 merge commit 统一提交。
