...
func seedRAGConversationKnowledge(t *testing.T, ctx context.Context, pool *pgxpool.Pool, root string) {
	...
	statements := []struct {
		...
		{`INSERT INTO core.source_version(id,source_id,content_artifact_id,content_hash,byte_size,mime_type,original_content_location,security_status,captured_at) VALUES($1,$2,$3,$4,$5,'text/plain','docs/recovery.txt','passed',$6)`, []any{string(ragSmokeSourceVersionID), string(ragSmokeSourceID), string(ragSmokeArtifactID), contentHash, int64(len(content)), at}},
...
func seedComposeRAGProvenance(t *testing.T, ctx context.Context, pool *pgxpool.Pool) composeRAGKnowledgeFixture {
	...
	statements := []struct {
		...
		{`INSERT INTO core.source_version(id,source_id,content_artifact_id,content_hash,byte_size,mime_type,original_content_location,security_status,captured_at) VALUES($1,'a0000000-0000-4000-8000-000000000003','a0000000-0000-4000-8000-000000000002',$2,75,'text/plain','rag-smoke.txt','passed',$3)`, []any{string(fixture.SourceVersionID), contentHash, at}},
