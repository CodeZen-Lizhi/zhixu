...
export const DropdownMenu = ({ trigger, label, children }: { trigger: ReactElement; label: string; children: ReactNode }) => <DropdownMenuPrimitive.Root><DropdownMenuPrimitive.Trigger asChild>{trigger}</DropdownMenuPrimitive.Trigger><DropdownMenuPrimitive.Portal><DropdownMenuPrimitive.Content className="ui-dropdown" align="end" sideOffset={8} aria-label={label}>{children}</DropdownMenuPrimitive.Content></DropdownMenuPrimitive.Portal></DropdownMenuPrimitive.Root>;
