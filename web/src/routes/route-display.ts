export type RouteSection = "notes" | "dashboard" | "knowledge" | "authoring" | "settings";
...
export const routeDisplayRegistry: readonly RouteDisplay[] = [
  ...
  { basePath: "/dashboard", label: "工作台", section: "dashboard", navigation: { placement: "primary", label: "工作台", order: 1, icon: "dashboard" } },
  { basePath: "/inbox", label: "资料收件箱", section: "knowledge", navigation: { placement: "primary", label: "知识", order: 2, icon: "inbox", group: { label: "资料", icon: "folder-open", order: 0, itemOrder: 0 } } },
  ...
  { basePath: "/authoring", label: "创作", section: "authoring", navigation: { placement: "primary", label: "创作", order: 3, icon: "square-pen" } },
  { basePath: "/authoring/new", label: "新建文章", parentLabel: "创作", section: "authoring" },
  { basePath: "/authoring/notes", label: "主笔记", section: "notes", navigation: { placement: "primary", label: "主笔记", order: 0, icon: "book-open-check" } },
