...
import type { HealthIssue, HealthIssueListItem, HealthScan, HealthSummary } from "../../api/health";
...
describe("HealthPage", () => {
  it("restores scan state from URL and lazy-loads Evidence details", async () => {
    ...
    hooks.useHealthIssue.mockReturnValue({ data: { issue, latestObservation: null, observations: [], decisions: [] }, isPending: false, isError: false, refetch: vi.fn() });
