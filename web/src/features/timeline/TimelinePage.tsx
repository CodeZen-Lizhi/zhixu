...
export const TimelinePage = () => {
  ...
  return <div className="timeline-workbench">
    <header className="timeline-hero"><div><p className="eyebrow">Knowledge Timeline</p><h2>事件与影响</h2></div><Button variant="secondary" onClick={() => void timeline.refetch()} disabled={timeline.isFetching}><RefreshCw size={16} />{timeline.isFetching ? "正在刷新" : "刷新"}</Button></header>
